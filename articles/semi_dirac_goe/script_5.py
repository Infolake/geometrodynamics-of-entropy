# Criar script Python completo para facilitar a execução
...
with open('generate_goe_figures.py', 'w') as f:
    f.write(script_content)
    
print("✓ Script Python completo salvo como: generate_goe_figures.py")
print("Para executar: python generate_goe_figures.py")
print("\nEste script gera todas as figuras necessárias para o artigo!")